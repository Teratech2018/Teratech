...
public class CourrierInterneJoint extends BaseElement implements Serializable, Comparable<CourrierInterneJoint> {
	...
	private CourrierInterneJoint origanal;
	...
	public CourrierInterneJoint(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	 ...
	 * 
	 */
	public CourrierInterneJoint() {
		// TODO Auto-generated constructor stub
	}

	public CourrierInterneJoint(CourrierInterneJoint dep) {
	...
	public CourrierInterneJoint(CourrierDepart dep) {
...
//		}
	...
	public CourrierInterneJoint(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierInterneJoint(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierInterneJoint getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierInterneJoint origanal) {
	...
	@Override
	public int compareTo(CourrierInterneJoint o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierInterneJoint newInstace() {
		CourrierInterneJoint entity = new CourrierInterneJoint();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierInterneJoint(this.origanal);
		}
