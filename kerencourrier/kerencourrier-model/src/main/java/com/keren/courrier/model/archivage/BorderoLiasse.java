 ...
 */
@Entity
@Table(name = "T_BORLIAS")
public class BorderoLiasse extends BaseElement implements Serializable,Comparable<BorderoLiasse>{

    @Predicate(label = "Bordero",optional = true,unique = true,search = true)
    private String code; 
    
    
  //  @Predicate(label = "Type de bordereau",target = "combobox",values = "Interne;Départ;Confidentiel",updatable = true)
    private String type ;
...
//    @Predicate(label = "Date émission",type = Date.class,target = "date",editable =false,search = true)
    ...
    @Predicate(label ="",type = LigneBorderoLiasse.class,target = "one-to-many",group = true,groupName = "group1",groupLabel = "Listes des Liasses",edittable = true)
    private List<LigneBorderoLiasse> lignes = new ArrayList<LigneBorderoLiasse>();

    @Predicate(label = "Statut",search = true,hide = true)
    private String state = "etabli";
    
    
     public BorderoLiasse(BorderoLiasse entity) {
    ...
    public BorderoLiasse(String code, StructureCompany service, long id, String designation, String moduleName, long comparedid) {
        super(id, designation, moduleName, comparedid);
        this.code = code;
        
    }

    public BorderoLiasse() {
    }
    ...
    public String getListTitle() {
        return "Parafeurs des liasses"; //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public String getEditTitle() {
        return "Parafeur  des liasses"; //To change body of generated methods, choose Tools | Templates.
    }
	...
	public List<LigneBorderoLiasse> getLignes() {
		return lignes;
	}

	public void setLignes(List<LigneBorderoLiasse> lignes) {
		this.lignes = lignes;
	}
    ...
    @Override
    public int compareTo(BorderoLiasse o) {
