...
public class CourrierAArchiver extends BaseElement implements Serializable, Comparable<CourrierAArchiver> {
...
//	private UtilisateurCourrier destinataire;
	...
	private CourrierAArchiver origanal;
	...
	public CourrierAArchiver(String categorie, String niveauDeTraitement, TypeCourrier typecourrier, Priorite priorite,
	 ...
	 * 
	 */
	public CourrierAArchiver() {
		// TODO Auto-generated constructor stub
	}

	public CourrierAArchiver(CourrierAArchiver dep) {
...
//		}
	...
	public CourrierAArchiver(CourrierDepart dep) {
...
//		}
	...
	public CourrierAArchiver(Courrier dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierAArchiver(CourrierInterne dep) {
		super(dep.getId(), dep.getDesignation(), dep.getModuleName(), dep.getCompareid());
		this.categorie = dep.getCategorie();
		this.code = dep.getCode();
	...
	public CourrierAArchiver getOriganal() {
		return origanal;
	}

	public void setOriganal(CourrierAArchiver origanal) {
...
//	}
	...
	@Override
	public int compareTo(CourrierAArchiver o) {
		// TODO Auto-generated method stub
		return code.compareTo(o.code);
	}

	public CourrierAArchiver newInstace() {
		CourrierAArchiver entity = new CourrierAArchiver();
		...
		if (this.origanal != null) {
			entity.origanal = new CourrierAArchiver(this.origanal);
		}
