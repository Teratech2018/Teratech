...
public class DocumentAchat extends BaseElement implements Serializable,Comparable<DocumentAchat>{
    ...
    @TableFooter(value = "<tr style='border:none;'> <td></td><td></td><td></td><td></td><td></td><td style='font-weight: bold;'>Total HT</td><td></td> <td class='text-right'>this.quantite,*,this.puht,*,(,100,-,this.remise,),/,100</td> </tr> <tr style='border:none;'> <td></td><td></td><td></td><td></td><td></td><td  style='font-weight: bold;'>Taxes</td><td></td> <td  class='text-right'>(,this.quantite,*,this.puht,*,(,100,-,this.remise,),/,100,),*,this.taxe.montant,/,100</td> </tr> <tr style='border:none;'> <td></td><td></td><td></td><td></td><td></td><td  style='font-weight: bold;'>Total TTC</td><td></td><td  class='text-right'  style='font-weight: bold;'>(,this.quantite,*,this.puht,*,(,100,-,this.remise,),/,100,),*,(100,+,this.taxe.montant,),/,100</td> </tr>")
