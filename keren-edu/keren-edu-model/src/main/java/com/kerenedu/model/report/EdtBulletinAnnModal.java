...
public class EdtBulletinAnnModal extends BaseElement implements Serializable, Comparable<EdtBulletinAnnModal> {
	...
	@Predicate(label = "Annee Scolaire", updatable = true, type = AnneScolaire.class, target = "many-to-one", sequence = 1, observable = true, optional = false)
	protected AnneScolaire annee;
	...
	// @Observer(observable="classe", source="method:getidclasse",
	// parameters="classe")
	private String porte = "0";

	@ManyToMany
	// @Predicate(label="EM", type=Inscription.class,
	// target="many-to-many-list", group=true, groupName="group1",
	// groupLabel="Liste des Elèves", hidden="temporalData.porte=='0' ||
	// temporalData.porte==null")
