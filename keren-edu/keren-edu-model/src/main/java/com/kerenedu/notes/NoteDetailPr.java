 ...
 */
@Table
@Entity(name = "e_notedltpr")
public class NoteDetailPr extends BaseElement implements Serializable, Comparable<NoteDetailPr> {
	...
	@Column(name = "NOTE_1")
	@Predicate(label = "MOIS 1",type = Double.class,search = true  , sequence=3 )
	private Double note1 = new Double(0) ;
	
	@Column(name = "NOTE_2")
	@Predicate(label = "MOS 2",type = Double.class,search = true  , sequence=4 )
	private Double note2 = new Double(0) ;
	
	@Column(name = "NOTE_3")
	@Predicate(label = "MOIS 3",type = Double.class,search = true  , sequence=5)
	...
	public NoteDetailPr(NoteDetailPr notedetail) {
	...
	public NoteDetailPr(Inscription eleve) {
	...
	public int compareTo(NoteDetailPr o) {
		// TODO Auto-generated method stub
		return 0;
	}
