...
public class BulletinHelper2 extends BaseElement implements Serializable, Comparable<BulletinHelper2> {
...
//	protected Examen examen;
	...
	public BulletinHelper2(Inscription inscription, Classe classe, Bulletin bulletin, String anneeid, Double moyt1,
	...
	public BulletinHelper2(BulletinHelper2 bull) {
	...
	public int compareTo(BulletinHelper2 o) {
		// TODO Auto-generated method stub
		return 0;
	}
