 ...
 */
@Table
@Entity(name = "e_bul_lgn_pr")
public class LigneBulletinClassePrimaire extends BaseElement implements Serializable, Comparable<LigneBulletinClassePrimaire> {

	@ManyToOne
	@JoinColumn(name = "MOD_ID")
	@Predicate(label = "Discipline", updatable = false, search = true, type = GroupeCours.class, target = "many-to-one", sequence = 1, editable = false)
...
//	protected Professeur prof;
	...
	@Column(name = "NOTE_1")
	@Predicate(label = "Mois 1",type = Double.class,search = true  , sequence=3 ,editable=false)
	private Double note1 = new Double(0) ;
	
	@Column(name = "NOTE_2")
	@Predicate(label = "Mois 2",type = Double.class,search = true  , sequence=4 ,editable=false)
	private Double note2 = new Double(0) ;
	
	@Column(name = "NOTE_3")
	@Predicate(label = "MOIS 3",type = Double.class,search = true  , sequence=5,editable=false )
	private Double note3 = new Double(0) ;

	@Column(name = "NOTE")
//	@Predicate(label = "Mois 3",type = Double.class,search = true  , sequence=6, editable=false )
	private Double note = new Double(0) ;
	
	@Column(name = "S-NOTE_1")
	//@Predicate(label = "Mois 1",type = Double.class,search = true  , sequence=3 ,editable=false)
	...
	public LigneBulletinClassePrimaire() {
		super();
		// TODO Auto-generated constructor stub
	}

	public LigneBulletinClassePrimaire(MatiereDlt matiere, Professeur prof, Double note, Double moyenne, Long coef,
...
//		this.prof = prof;
	...
	public LigneBulletinClassePrimaire(LigneBulletinClassePrimaire filiere) {
...
//		this.prof = new Professeur(filiere.prof);
	...
	public LigneBulletinClassePrimaire(ViewNoteHelper helper) {
...
//		this.note3 = helper.getNote3()*helper.getExamen().getE3();
	...
	public int compareTo(LigneBulletinClassePrimaire o) {
		// TODO Auto-generated method stub
		return 0;
	}
