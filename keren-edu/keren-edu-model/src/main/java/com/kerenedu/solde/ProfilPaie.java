...
public class ProfilPaie extends BaseElement implements Serializable, Comparable<ProfilPaie> {
	...
	public ProfilPaie(String code, String label, Etablissement societe, Boolean actif, String state,
	...
	public ProfilPaie(ProfilPaie entity) {
	...
	public int compareTo(ProfilPaie o) {
