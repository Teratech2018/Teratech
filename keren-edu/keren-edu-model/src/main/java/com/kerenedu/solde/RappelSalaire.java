...
public class RappelSalaire extends BaseElement implements Serializable, Comparable<RappelSalaire> {
	 ...
	 * @param moduleName
	 */
	public RappelSalaire(long id, String designation, String moduleName) {
	...
	public RappelSalaire(long id, String designation, String moduleName, Professeur employe, String type, Date debut, Date fin,
