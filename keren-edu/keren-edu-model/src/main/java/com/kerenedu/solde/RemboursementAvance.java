...
//	@Predicate(label="Structure",type=Societe.class,target="many-to-one",search=true)
	...
	public RemboursementAvance(long id, String designation, String moduleName, AvanceSalaire avance, Etablissement societe,
	...
	public RemboursementAvance(RemboursementAvance rem) {
		...
		if(rem.societe!=null){
			this.societe = new Etablissement(rem.societe);
		}
		this.date = rem.date;
