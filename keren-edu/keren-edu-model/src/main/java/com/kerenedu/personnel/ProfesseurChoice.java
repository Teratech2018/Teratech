...
public class ProfesseurChoice extends BaseElement implements Serializable, Comparable<ProfesseurChoice> {
...
//			,group = true, groupLabel = "Informations Professionnelles", groupName = "tab2")
	...
	@Column(name = "NAT_PAI")
//	@Predicate(label = "Mode Paiement", optional = false, updatable = true, search = false, target = "combobox", values = "Espèces;Virements", sequence =8, observable = true,
...
//	protected ProfilPaielight profil;
	...
	public ProfesseurChoice() {

	}


	public ProfesseurChoice(String image, String nom, String matricule, String status, String sexe, Date dateEmb, Fonction role,
	...
	public ProfesseurChoice(ProfesseurChoice entity) {
...
//		}
		...
		if(entity.role!=null){
			this.role= new Fonction(entity.getRole());
		}
...
//	}
	...
	public boolean equals(Object obj) {
		...
		final ProfesseurChoice other = (ProfesseurChoice) obj;
...
//	}
	...
	public int compareTo(ProfesseurChoice o) {
		// TODO Auto-generated method stub
		return 0;
	}
