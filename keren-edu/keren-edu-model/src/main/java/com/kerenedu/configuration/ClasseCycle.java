...
@Entity
@Table(name = "e_classe")
public class ClasseCycle extends BaseElement implements Serializable, Comparable<ClasseCycle> {
...
//	
	...
	public ClasseCycle(ClasseCycle filiere) {
...
//	}
	...
	public int compareTo(ClasseCycle o) {
		// TODO Auto-generated method stub
		return 0;
	}
