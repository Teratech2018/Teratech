    ...
    implements TypeContratRS
{
     ...
     * 
     */
    @Manager(application = "kereneducation", name = "TypeContratManagerImpl", interf = TypeContratManagerRemote.class)
    ...
    @Override
   	public MetaData getMetaData(HttpHeaders headers) {
   		...
   		try {
   			return MetaDataUtil.getMetaData(new TypeContrat(), new HashMap<String, MetaData>(),new ArrayList<String>());
   		}  catch (Exception e) {
