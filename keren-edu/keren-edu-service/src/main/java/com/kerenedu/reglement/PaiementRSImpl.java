 ...
 */
@Path("/paiement")
public class PaiementRSImpl
    extends AbstractGenericService<Paiement, Long>
    implements PaiementRS
{
    ...
    @Override
   	public MetaData getMetaData(HttpHeaders headers) {
   		...
   		try {
   			return MetaDataUtil.getMetaData(new Paiement(), new HashMap<String, MetaData>(),new ArrayList<String>());
