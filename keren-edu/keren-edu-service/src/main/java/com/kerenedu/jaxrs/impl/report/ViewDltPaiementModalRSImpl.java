...
public class ViewDltPaiementModalRSImpl
    extends AbstractGenericService<ViewDltPaiementModal, Long>
    implements ViewDltPaiementModalRS
{
    ...
    @Override
   	public MetaData getMetaData(HttpHeaders headers) {
   		...
   		try {
   			return MetaDataUtil.getMetaData(new ViewDltPaiementModal(), new HashMap<String, MetaData>(),new ArrayList<String>());
   		}  catch (Exception e) {
