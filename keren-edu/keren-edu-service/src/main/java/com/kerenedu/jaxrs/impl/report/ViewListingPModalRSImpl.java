...
import com.kerenedu.jaxrs.ifaces.report.ViewListingPModalRS;
 ...
 * 
 */
@Path("/viewlistingpmodal")
public class ViewListingPModalRSImpl extends AbstractGenericService<ViewListingPModal, Long>
		implements ViewListingPModalRS {
	...
	protected ViewDltPaiementManagerRemote managerp;

	public ViewListingPModalRSImpl() {
		super();
	}
	...
	public MetaData getMetaData(HttpHeaders headers) {
		...
		try {
			return MetaDataUtil.getMetaData(new ViewListingPModal(), new HashMap<String, MetaData>(),
	 ...
	 */
	@Override
	public GenericManager<ViewListingPModal, Long> getManager() {
		return null;
	}
	...
	public Response buildPdfReport(ViewListingPModal entity) {
		try {
			List<ViewDltPaiement> records = managerp.getCriteres(entity);
			...
			String URL = ReportHelper.templateURL + ReportsName.LINSTINGPAIEMENT_TYPE.getName();
